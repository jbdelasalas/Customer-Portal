...
const FILTERS = [
  ...
  { key: 'info_requested', label: 'Awaiting customer' },
  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-10">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Customer applications</h1>
          <p className="mt-1 text-sm text-slate-600">
            {summary.submitted ?? 0} new · {summary.under_review ?? 0} in review ·{' '}
            {summary.info_requested ?? 0} awaiting customer
          </p>
        </div>
        <input
